...
const projectData = [
  {
    title: "zomato clone",
    subTitle:
      "A clone of the zomato website",
    thumbnail: "./portfolio-master/img/Screenshot 2024-09-24 171821.webp",
    description:
      "This is a clone of the zomato website that I made to sharpen my HTML and CSS skills.",
    techStack: ["HTML", "CSS"],
    srcURL: "https://parvathy0810.github.io/clone-1-zomato-/",
  },
  {
    title: "Tesla clone",
    subTitle:
    ...
    techStack: ["HTML", "CSS"],
    srcURL: "https://parvathy0810.github.io/clone-2-tesla/",
  },
  ...
  const ProjectCard = function (data) {
   ...
   <img class="card-img-top img-fluid" style="height: 200px; object-fit: cover;" src={thumbnail} alt="Card image cap">
       ...
       <div class="card-buttons">
          <a href="https://github.com/PARVATHY0810" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
...
async function getRepoList() {
  try {
    const response = await fetch(
      "https://api.github.com/users/PARVATHY0810/repos"
    );
